...
const ONBOARDING_USER = 'networkmap_onboardingUser'
    ...
    return client.service('users')
      ...
      .then(user => {
        ...
        dispatch({
          type: 'ONBOARDING_SNACKBAR_SET',
          snackbar: {
            message: `Hey ${name}, we sent you an email at ${email} with a link to set yourself up on the YIP Alumni Network!`,
            error: false
          }
        })
      })
